...
write.table(S,
            file = paste('E:/ASU/Simulations/RDF QRP Sim/Data Generation/S/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')
...
write.table(etaOG,
            file = paste('E:/ASU/Simulations/RDF QRP Sim/Data Generation/eta/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')
...
write.table(lambdaOG,
            file = paste('E:/ASU/Simulations/RDF QRP Sim/Data Generation/lambda/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')
...
write.table(yForm,
            file = paste('E:/ASU/Simulations/RDF QRP Sim/Data Generation/yForm/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')
...
write.table(yDF,
            file = paste('E:/ASU/Simulations/RDF QRP Sim/Data Generation/y/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')
