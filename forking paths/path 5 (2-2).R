...
#objects
write.table(targ,
            paste('C:/RDF QRP Sim/path 5/saved objects/target rotation/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(targPhi,
            paste('C:/RDF QRP Sim/path 5/saved objects/factor correlations (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(efaPhi,
            paste('C:/RDF QRP Sim/path 5/saved objects/factor correlations/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(genLoad,
            paste('C:/RDF QRP Sim/path 5/saved objects/generating loadings/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(targTop1,
            paste('C:/RDF QRP Sim/path 5/saved objects/greatest absolute loadings (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(targTop2,
            paste('C:/RDF QRP Sim/path 5/saved objects/greatest negative loadings (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(estTop1,
            paste('C:/RDF QRP Sim/path 5/saved objects/greatest absolute loadings/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(estTop2,
            paste('C:/RDF QRP Sim/path 5/saved objects/greatest negative loadings/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(targLoadRes,
            paste('C:/RDF QRP Sim/path 5/saved objects/ss residual (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(targLoadAbs,
            paste('C:/RDF QRP Sim/path 5/saved objects/mean absolute bias (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(target,
            paste('C:/RDF QRP Sim/path 5/saved objects/estimated loadings (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(estLoadRes,
            paste('C:/RDF QRP Sim/path 5/saved objects/ss residual/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(estLoadAbs,
            paste('C:/RDF QRP Sim/path 5/saved objects/mean absolute bias/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(estimated,
            paste('C:/RDF QRP Sim/path 5/saved objects/estimated loadings/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(targCompK,
            paste('C:/RDF QRP Sim/path 5/saved objects/congruence coefficient (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

write.table(estCompK,
            paste('C:/RDF QRP Sim/path 5/saved objects/congruence coefficient/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')
...
write.table(finalCheck, 
            paste('C:/RDF QRP Sim/path 5/checks/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'.dat',sep=''),
            row.names = FALSE,
            col.names = TRUE,
            sep = '\t')

write.table(finalRecov, 
            paste('C:/RDF QRP Sim/path 5/recovery/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'.dat',sep=''),
            row.names = FALSE,
            col.names = TRUE,
            sep = '\t')
