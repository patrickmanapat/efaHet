...
# 
# mod1 <- '
#         eta1 =~ NA*V1 + V2 + V3 + V4 + V5 + V6 + V7 + V8
#         eta2 =~ NA*V9 + V10 + V11 + V12 + V13 + V14 + V15 + V16
#         eta3 =~ NA*V17 + V18 + V19 + V20 + V21 + V22 + V23 + V24
#         eta1 ~~ 1*eta1
#         eta2 ~~ 1*eta2
#         eta3 ~~ 1*eta3
#         '
...
write.table(yDF,
            file = paste('../yMini/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')
