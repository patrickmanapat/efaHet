...
data <- read.table(paste('../yMini/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
                   header = FALSE,
                   sep = '\t')
...
#objects
# write.table(targ,
#             paste('./5K/objects/target rotation/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(targPhi,
#             paste('./5K/objects/factor correlations (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')

write.table(efaPhi,
            paste('./factor correlations/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
            row.names = FALSE,
            col.names = FALSE,
            sep = '\t')

# write.table(genLoad,
#             paste('./5K/objects/generating loadings/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(targTop1,
#             paste('./5K/objects/greatest absolute loadings (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(targTop2,
#             paste('./5K/objects/greatest negative loadings (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(estTop1,
#             paste('./5K/objects/greatest absolute loadings/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(estTop2,
#             paste('./5K/objects/greatest negative loadings/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(targLoadRes,
#             paste('./5K/objects/ss residual (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(targLoadAbs,
#             paste('./5K/objects/mean absolute bias (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(target,
#             paste('./5K/objects/estimated loadings (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(estLoadRes,
#             paste('./5K/objects/ss residual/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(estLoadAbs,
#             paste('./5K/objects/mean absolute bias/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(estimated,
#             paste('./5K/objects/estimated loadings/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(targCompK,
#             paste('./5K/objects/congruence coefficient (target)/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
# 
# write.table(estCompK,
#             paste('./5K/objects/congruence coefficient/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'d',d,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = FALSE,
#             sep = '\t')
...
#             paste('./5K/checks/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'.dat',sep=''),
#             row.names = FALSE,
#             col.names = TRUE,
#             sep = '\t')

write.table(finalRecov, 
            paste('./recovery/','nEta',nEta,'pEta',pEta,'rEta',rEta,'l',l,'n',n,'.dat',sep=''),
            row.names = FALSE,
            col.names = TRUE,
            sep = '\t')
...
EFAsim(100,3, 8,0.0,0.45)
EFAsim(400,3, 8,0.0,0.45)
EFAsim(100,5, 8,0.0,0.45)
EFAsim(400,5, 8,0.0,0.45)
...
EFAsim(100,3, 8,0.0,0.89)
EFAsim(400,3, 8,0.0,0.89)
EFAsim(100,5, 8,0.0,0.89)
EFAsim(400,5, 8,0.0,0.89)
