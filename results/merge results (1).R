...
write.table(naDF, 'C:/Users/Patrick Manapat/Dropbox (ASU)/Research/Dissertation/Paper 3/Simulation/Estimation & Recovery/recovery/naData.dat',
            row.names = FALSE,
            col.names = TRUE,
            sep = "\t")
...
write.table(nNA, 'C:/Users/Patrick Manapat/Dropbox (ASU)/Research/Dissertation/Paper 3/Simulation/Estimation & Recovery/recovery/naSummary.dat',
            row.names = FALSE,
            col.names = TRUE,
            sep = "\t")
...
cat('\n', 
    file = 'C:/Users/Patrick Manapat/Dropbox (ASU)/Research/Dissertation/Paper 3/Simulation/Estimation & Recovery/recovery/naSummary.dat', 
    append = TRUE)
...
write.csv(allDF, 'C:/Users/Patrick Manapat/Dropbox (ASU)/Research/Dissertation/Paper 3/Simulation/Estimation & Recovery/recovery/anovaData.csv',
            row.names = FALSE)
